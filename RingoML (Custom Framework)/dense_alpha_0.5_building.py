...
#%%
'''
p1,p2,p3,p4,p5 = test.save_model()
print("\np3\n",p3,"\np2\n",p2,"\np1\n",p1)
w1,b1 = p1
w2,b2 = p2
w3,b3 = p3
...
print("accuracy =", np.round(acc/1000,2))    
#print(X,"\n\n",Activation('PReLU', X),"\n\n",BackActivation('PReLU', X))
'''
'''
Expected Output:
Loss after 0 epochs = 0.12493748321113599
Loss after 500 epochs = 0.12493748134799333
Loss after 1000 epochs = 0.12493748115802175
Loss after 1500 epochs = 0.12493748104686174
Loss after 2000 epochs = 0.12493748096798321
Loss after 2500 epochs = 0.12493748090679642
Loss after 3000 epochs = 0.12493748085680124
Loss after 3500 epochs = 0.12493748081452981
Loss after 4000 epochs = 0.12493748077791195
Loss after 4500 epochs = 0.1249374807456122
Loss after 5000 epochs = 0.12493748071671884
Loss after 5500 epochs = 0.12493748069058132
Loss after 6000 epochs = 0.1249374806667195
Loss after 6500 epochs = 0.12493748064476863
Loss after 7000 epochs = 0.12493748062444515
Loss after 7500 epochs = 0.1249374806055244
Loss after 8000 epochs = 0.12493748058782513
Loss after 8500 epochs = 0.1249374805711992
Loss after 9000 epochs = 0.12493748055552378
Loss after 9500 epochs = 0.1249374805406961

***Plot of Loss***

p3
 (array([[1.34051801, 0.41746491]]), array([1.68916284e-09])) 
p2
 (array([[ 0.93132911, -0.82634474,  0.26464185],
       [-1.57277065,  0.78304481, -1.65350674]]), array([2.26435369e-09, 7.05165227e-10])) 
p1
 (array([[-1.21088735,  0.46026061, -0.55594381,  0.80855498, -1.2196396 ,
        -0.06859266,  0.46742526,  0.30957735, -1.02680702,  0.20440193],
       [ 0.05871307,  0.14826173, -0.6876813 , -0.46851498,  0.43520164,
         0.16290459, -0.80604467,  0.93140815,  0.60120673,  0.37057876],
       [-0.32417548,  1.02302389, -0.60044572, -1.28031817, -1.06587578,
        -1.41533015, -1.98629584, -0.20795873, -1.24582833, -0.86131323]]), array([ 1.97557290e-10, -1.06908222e-09, -5.66751509e-11]))
accuracy = 0.6
'''